...
class ChatbotSessionManager(PyXavi):
    ...
    async def initialize_tooling(self):
        ...
        #         # # Custom Commands
        #         self.clients["system_date"].get_local_system_date,
        #         self.clients["system_time"].get_local_system_clock_time,
        ...
        #         self.clients["volume"].get_local_system_speaker_volume_level,
        #         self.clients["volume"].get_local_system_speaker_mute_status,
        #         self.clients["volume"].set_local_system_speaker_volume_level,
        #         self.clients["volume"].set_local_system_speaker_mute_status,
