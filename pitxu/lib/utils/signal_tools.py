...
https://raw.githubusercontent.com/neuml/txtai/refs/heads/master/src/python/txtai/pipeline/audio/signal.py
"""
...
class SignalTools:
    ...
    @staticmethod
    def float32(audio: np.ndarray) -> np.ndarray:
        """
    ...
    @staticmethod
    def mix(audio1: np.ndarray, audio2: np.ndarray, scale1: float = 1, scale2: float = 1) -> np.ndarray:
        """
    ...
    @staticmethod
    def energy(audio: np.ndarray, rate: int) -> dict[int, float]:
        """
    ...
    @staticmethod
    def trim(audio: np.ndarray, rate: int, threshold: float = 1, leading: bool = True, trailing: bool = True) -> np.ndarray:
        """
        ...
        while offset + n <= len(audio):
            ...
            energyfreq = SignalTools.energy(chunk, rate)
